...
def register(add_parser, add_defaults):
    ...
    submit_parser.add_argument('--disk-request', help='disk request for job', type=check_positive)
    submit_parser.add_argument('--disk-limit', help='disk limit for job', type=check_positive)
    submit_parser.add_argument('--disk-type', help='disk type for job', type=str)
